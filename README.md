...
**软件免费开源、无需上传视频，隐私安全**。支持识别日语/英语/韩语/中文/粤语/法语/德语/西班牙语/俄语等 15 种语言，可翻译成中文/英语/日语/韩语等 11 种目标语言。

> 💰 **费用说明（重要）**：软件本身、语音识别全部免费（本地 Whisper 模型）；翻译自带免费后端（MyMemory，质量一般，零成本）；想要**最佳翻译质量**可选用 DeepSeek AI，约 **几毛钱一部电影**，按量计费、可随时关闭。
